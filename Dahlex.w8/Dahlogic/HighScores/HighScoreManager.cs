...
namespace Dahlex.Logic.HighScores
{
    public class HighScoreManager
    {
        ...
        {
            // _settings = settings;
            //          var s = settings.LoadLocalSettings();
            //      _max = (s.BoardSize.Width * s.BoardSize.Height) / 4;
        ...
        public List<HighScore> LoadLocalHighScores()
        {
            ...
            //   foreach (HighScore moddedScore in _scores)
            //   {
            //       if (moddedScore != null && moddedScore.Level > _max && !moddedScore.Name.EndsWith("*"))
            //       {
            //           moddedScore.Name += " *";
            //       }
            //   }
